...
namespace Nektar
{
    namespace Thread
    {
        ...
        public:
            ...
            /**
             * @brief True if this ThreadManager has been initialised.
             *
 ...
 *     as a single-threaded ThreadManager that fails if anything non-trivial is attempted.
 *     This means code should be cautious about caching the value of GetInstance(string),
 *     as it might change once that particular threading system is initialised.
 *
 ...
 */
        class ThreadMaster
        {
            ...
            public:
                ...
                ~ThreadMaster();
                /**
                 * @brief Sets what ThreadManagers will be created in CreateInstance.
                 *
                ...
                /**
                 * @brief Gets the ThreadManager associated with string s.
                 *
