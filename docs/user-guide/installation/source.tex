...
\begin{itemize}
    ...
    If Open MPI does not work when it is fetched automatically from the source, it is possible to install it manually by downloading the software from the official website \url{https://www.open-mpi.org/software/ompi/v2.0/}
